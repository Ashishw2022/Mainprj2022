...
//        String pemail = session.getSession();
//
...
//     //todochanged    the phone to mail id
//        prescription_doctor.child(email.replace('.',',')).child(pemail.replace('.',',')).addValueEventListener(new ValueEventListener() {
//            @Override
