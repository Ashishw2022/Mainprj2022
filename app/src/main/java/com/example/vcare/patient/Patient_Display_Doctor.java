...
public class Patient_Display_Doctor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference reference_details = FirebaseDatabase.getInstance("https://vcaredb-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Patient_Details");
