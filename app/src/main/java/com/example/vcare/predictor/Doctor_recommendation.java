...
public class Doctor_recommendation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String speciality_type = getIntent().getStringExtra("disease_category");
...
//                        }
                    ...
                    if(listData.isEmpty()){
                        Toast.makeText(Doctor_recommendation.this,"No Doctor is available",Toast.LENGTH_SHORT).show();
                        progressBar.setVisibility(View.INVISIBLE);
                    }
                    adapter = new Doctors_Adapter(listData, emaildata, Doctor_recommendation.this);
