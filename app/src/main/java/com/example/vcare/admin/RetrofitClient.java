...
public class RetrofitClient {
    ...
    private static final String BASE_URL = "https://api.mailgun.net/v3/sandboxf219dd611f9e466d8a424f2212a44539.mailgun.org/messages/";

    private static final String API_USERNAME = "api";

    //you need to change the value to your API key
    private static final String API_PASSWORD = "16d1888915499568bd8fea5d9dd1c5c5-523596d9-757411f7";
