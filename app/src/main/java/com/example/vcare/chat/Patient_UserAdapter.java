...
public class Patient_UserAdapter extends RecyclerView.Adapter<Patient_UserAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String url = "";
        DatabaseReference reference = FirebaseDatabase.getInstance("https://vcare-healthapp-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Doctors_Data").child(email).child("doc_pic");
