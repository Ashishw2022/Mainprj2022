...
public class Predico_detailview extends AppCompatActivity {
    ...
    private Predictiondetails_BySpecialityAdapter adapter ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   navigationView = findViewById(R.id.nav_view);
      //  toolbar = findViewById(R.id.toolbar);
        ...
        doctors_reference.child(encodedemail).addValueEventListener(new ValueEventListener() {
            @Override
                ...
                if (dataSnapshot.exists()) {
                    //   for (DataSnapshot npsnapshot : dataSnapshot.getChildren()) {
                      //  String email = dataSnapshot.getKey().replace(",", ".");
                        ...
                        Doctors_Profile l = dataSnapshot.getValue(Doctors_Profile.class);
                        emailNewList.put(encodedemail,l);
        ...
        nm.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()){
                   for (DataSnapshot npsnapshot : dataSnapshot.getChildren()){
                        for (DataSnapshot snapshot : npsnapshot.getChildren()) {
                            for (Map.Entry<String, Doctors_Profile> stringDoctorsEntry : emailNewList.entrySet()) {
                                ...
                                Doctors_Profile dp = stringDoctorsEntry.getValue();
                    ...
                    adapter=new Predictiondetails_BySpecialityAdapter(listData,emaildata, Predico_detailview.this);
